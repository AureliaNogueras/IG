...
void _triangulos3D::draw_solido_ajedrez(float r1, float g1, float b1, float r2, float g2, float b2)
{
  ...
  glColor3f(r1,g1,b1);
  glBegin(GL_TRIANGLES);
  for (unsigned int i=0;i<caras.size();i=i+2){
    glVertex3fv((GLfloat *) &vertices[caras[i]._0]);
    glVertex3fv((GLfloat *) &vertices[caras[i]._1]);
    glVertex3fv((GLfloat *) &vertices[caras[i]._2]);
  }
  ...
  glColor3f(r2,g2,b2);
  glBegin(GL_TRIANGLES);
  for (unsigned int i=1;i<caras.size();i=i+2){
    glVertex3fv((GLfloat *) &vertices[caras[i]._0]);
    glVertex3fv((GLfloat *) &vertices[caras[i]._1]);
    glVertex3fv((GLfloat *) &vertices[caras[i]._2]);
  }
...
caras[8]._0=3;caras[8]._1=0;caras[8]._2=4;
caras[9]._0=4;caras[9]._1=7;caras[9]._2=3;
...
if (fabs(perfil[0].x)>0.0)
  {
    ...
    for (i=0;i<num*num_aux;i=i+num_aux){ 
      cara_aux._0=i;
      cara_aux._1=num*num_aux;
      cara_aux._2=(i+num_aux)%(num_aux*num);
      caras.push_back(cara_aux);
    }
  }
...
if (fabs(perfil[num_aux-1].x)>0.0)
  {
    ...
    for (i=num_aux-1;i<num*num_aux;i=i+num_aux){ 
      cara_aux._0=i;
      cara_aux._1=num*num_aux+1;
      cara_aux._2=(i+num_aux)%(num_aux*num);
      caras.push_back(cara_aux);
    }
  }
